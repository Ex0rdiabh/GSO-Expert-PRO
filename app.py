...
# -----------------------------
    ...
    with st.expander("Import Declaration Placement Settings"):
        ...
        decl_x0 = st.number_input("x0", value=155)
        decl_y0 = st.number_input("y0", value=272)
        decl_x1 = st.number_input("x1", value=505)
        decl_y1 = st.number_input("y1", value=322)
        decl_fontsize = st.number_input("Font Size", value=11)
